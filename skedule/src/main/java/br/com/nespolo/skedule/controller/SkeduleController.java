...
@ViewScoped
@Controller
@ManagedBean(name = "skeduleController")
public class SkeduleController implements Serializable
{

	private static final long serialVersionUID = -8971467679252979326L;

	private ScheduleModel eventModel;

	private ScheduleEvent event = new DefaultScheduleEvent();

	public SkeduleController()
	{
